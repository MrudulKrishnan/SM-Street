...
public class book extends AppCompatActivity {
    ...
    String name,image,price,stocks,pid,d, from_date, to_date;
    String url,quantity;
...
//        tv7.setTextColor(Color.BLACK);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                from_date = e2.getText().toString();
                to_date = e3.getText().toString();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (res.equalsIgnoreCase("valid")) {
                                ...
                                Toast.makeText(book.this, "Ordered!!", Toast.LENGTH_SHORT).show();
...
//                                startActivity(ik);
                                ...
                                Toast.makeText(book.this, "Not ordered!!", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent ik = new Intent(getApplicationContext(), book_product.class);
        startActivity(ik);
    }
