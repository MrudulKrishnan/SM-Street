...
class custom_search_product extends BaseAdapter {
    ...
    public custom_search_product(Context applicationContext, ArrayList<String> product_arg,ArrayList<String> details_arg,ArrayList<String> price_arg,
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_search_product,null);
...
//        Button b2_rating = gridView.findViewById(R.id.B2_Rating);
        ...
        b1_add_quantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context , shop_product_book.class);
