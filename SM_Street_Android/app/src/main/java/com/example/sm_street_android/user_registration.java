...
public class user_registration extends AppCompatActivity {
    EditText firstname, lastname, age, place, post, pin, phone, email, latitude, longitude, username, password;
...
//        Toast.makeText(getApplicationContext(), "IIIIIIIIIIIIIIIIIIIII", Toast.LENGTH_LONG).show();
        RequestQueue queue = Volley.newRequestQueue(user_registration.this);pd=new ProgressDialog(user_registration.this);
...
//            }
        ...
        Volley.newRequestQueue(user_registration.this).add(volleyMultipartRequest);
    }
