...
public class view_offers extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1_offer = findViewById(R.id.L1_offer);
        s1 = findViewById(R.id.SV1_ViewOffer);
        s1.setOnQueryTextListener(view_offers.this);



        url = "http://" + sh.getString("ip", "") + ":5000/view_offers";
        RequestQueue queue = Volley.newRequestQueue(view_offers.this);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
//                Toast.makeText(view_offers.this, "eeeerr" + response, Toast.LENGTH_SHORT).show();

                // Display the response string.
                Log.d("+++++++++++++++++", response);
                try {
//                    Toast.makeText(view_offers.this, "" + response, Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(view_offers.this, "err" + response, Toast.LENGTH_SHORT).show();


                    // ArrayAdapter<String> ad=new ArrayAdapter<>(Home.this,android.R.layout.simple_list_item_1,name);
                    //lv.setAdapter(ad);

                    l1_offer.setAdapter(new custom_view_offers(view_offers.this,
...
//                Toast.makeText(view_offers.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
    ...
    public boolean onQueryTextChange(String s) {
        ...
        url = "http://" + sh.getString("ip", "") + ":5000/search_view_offers";
        RequestQueue queue = Volley.newRequestQueue(view_offers.this);
