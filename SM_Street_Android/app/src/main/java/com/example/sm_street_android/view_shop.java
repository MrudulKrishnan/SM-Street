...
public class view_shop extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1.setOnQueryTextListener(view_shop.this);


        url = "http://" + sh.getString("ip", "") + ":5000/view_shop";
        RequestQueue queue = Volley.newRequestQueue(view_shop.this);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
//                Toast.makeText(view_shop.this, "eeeerr" + response, Toast.LENGTH_SHORT).show();

                // Display the response string.
                Log.d("+++++++++++++++++", response);
                try {
//                    Toast.makeText(view_shop.this, "" + response, Toast.LENGTH_SHORT).show();
                    ...
                    for (int i=0; i<ar.length(); i++) {
                        ...
                        shop_name_arr.add(jo.getString("shop"));
...
//                    Toast.makeText(view_shop.this, "err" + response, Toast.LENGTH_SHORT).show();


                    // ArrayAdapter<String> ad=new ArrayAdapter<>(Home.this,android.R.layout.simple_list_item_1,name);
                    //lv.setAdapter(ad);

                    l1_view_shop.setAdapter(new custom_view_shops(view_shop.this,
                            shop_name_arr, address_arr, user_phone_arr, user_email_arr, shop_id_arr));
...
//                    Toast.makeText(getApplicationContext(),"========="+e,Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(view_shop.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
    ...
    public boolean onQueryTextChange(String s) {
        ...
        url = "http://" + sh.getString("ip", "") + ":5000/search_view_shop";
        RequestQueue queue = Volley.newRequestQueue(view_shop.this);
